                   ...
                   <div class="col-md-8">
                      ...
                      <div class="form-group">
                         ...
                         <div class="input-group">
                            ...
                            <input id="input_post_thumbnail" name="thumbnail" value="{{ old('thumbnail', asset($post->thumnbnail)) }}" type="text" class="form-control @error('thumbnail') is-invalid @enderror"
...
@push('javascript-internal')
   ...
   // Event : input thumbnail
      ...
      toolbar2:
         "insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image media",file_picker_callback: function(callback, value, meta) {
