          ...
          <div class="card-body">
             <form action="{{ route('users.update', ['user' => $user]) }}" method="POST">
                ...
                <div class="form-group">
                   ...
                   <input id="input_user_name" value="{{ $user->name }}" name="name" type="text" class="form-control " placeholder="{{ trans('users.form_control.input.name.placeholder') }}" readonly />
                </div>
                <!-- email -->
                <div class="form-group">
                    ...
                    <input id="input_user_email" value="{{ $user->email }}" name="email" type="email" class="form-control " placeholder=" {{ trans('users.form_control.input.email.placeholder')  }}"
