          ...
          <div class="card-body">
             <form action="" method="POST">
                ...
                <div class="form-group">
                   ...
                   <input id="input_tag_slug" value="" name="slug" type="text" class="form-control" placeholder="{{ trans('tags.form_control.input.slug.placeholder') }}" readonly />
                </div>
                ...
                <div class="float-right">
                    <a class="btn btn-warning px-4 mx-2" href="{{ route('tags.index') }}">
                        {{ trans('tags.button.back.value') }}</a>
                </div>
